    ...
    `<div id="marginCSS">
        <div id="box-rDom">
            ...
            <div id="box-infos">
                ...
                <div id="box-credor">
                    <div class="titulos-formato">• Credor:<div id="credorNome" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Cpf:<div id="cpfCredor" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Rg:<div id="rgCredor" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Endereço:<div id="enderecoCredor" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• CEP:<div id="cepCredor" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Telefone:<div id="telefoneCredor" class="fonte-info-saida"></div>
                    </div>

                </div>
                <div id="box-devedor">
                    <div class="titulos-formato">• Devedor:<div id="devedorNome" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Cpf:<div id="cpfDevedor" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Rg:<div id="rgDevedor" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Endereço:<div id="enderecoDevedor" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• CEP:<div id="cepDevedor" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Telefone:<div id="telefoneDevedor" class="fonte-info-saida"></div>
                    </div>
                </div>
                <div class="titulos-partes">DADOS DO VEÍCULO:</div>
                <div id="box-veiculo">
                    <div class="titulos-formato">• Marca/Modelo:<div id="marcaVeiculo" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Placa:<div id="placaVeiculo" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Renavam:<div id="renavamVeiculo" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Chassi:<div id="chassiVeiculo" class="fonte-info-saida"></div>
                    </div>
                    <div class="titulos-formato">• Ano Fab/Modelo:<div id="anoVeiculo" class="fonte-info-saida"></div>
                    </div>
                </div>
                <div class="titulos-partes">DADOS DA VENDA:</div>
                <div id="box-venda">
                    <div class="titulos-formato">• Valor total: <div id="valorTotal" class="fonte-info-saida"></div>
                    </div>
                    ...
                    <div class="titulos-formato" id="parcelasCSS">• Parcelas:<div id="xParcelas"
                            class="fonte-info-saida"></div>parcelas de R$<div id="valorParcelas"
                            class="fonte-info-saida"></div>cada.
                    </div>
                    <div class="titulos-formato">• Primeira parcela: <div id="primeiraParcela"></div>
                    </div>
                    <div class="titulos-formato">• Última parcela: <div id="ultimaParcela"></div>
                    </div>
                    <div class="titulos-formato">• Formas de pagamento: <div id="formasPagamento"></div>
                    </div>
                </div>
            </div>
            ...
            <div id="divClau">
                <div id="clausula1">
                    ...
                    <div>
                        ...
                        valor total de R$<span class="fonte-info-saida" id="clausula1-total">20.520,00</span>.
                    </div>
                </div>
                <div id="clausula2">
                    ...
                    <div class="clausula2-2">
                        Por conta do preço referido na cláusula 1, o DEVEDOR pagou neste ato a quantia de R$ <span
                            class="fonte-info-saida" id="clausula-entrada-valor"></span> e o valor financiado de R$
                        <span class="fonte-info-saida" id="clausula-financiado-valor"></span>, que será pago em <span
                            class="fonte-info-saida" id="clausula-parcelas-numero"></span> parcelas de R$
                        <span class="fonte-info-saida" id="clausula-parcelas-valor"></span> cada, pago em dinheiro, PIX,
                        ou
                        transferência bancária, nas seguintes datas: a primeira em <span class="fonte-info-saida"
                            id="clausula-data-primeira"></span> e a última
                        em <span class="fonte-info-saida" id="clausula-data-ultima"></span>.
                    </div>
                    <!--GPT-->
                </div>
                <div id="clausula3">
            ...
            <div id="loc-data">Local e data: <div id="loc-data-valor"></div>
            </div>

            <div id="assinaturas">
                <div id="align1">
                    <div class="line">________________________________________</div>
                    <div id="credorAss"></div>
                </div>
                <div id="align2">
                    <div class="line">________________________________________</div>
                    <div id="devedorAss"></div>
                </div>
            </div>
